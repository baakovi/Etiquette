        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-center" style="margin: 10% 0 10% 0;">
                    ...
                    <h1 class="amostra-text">Paletós elegantes, para aprimorar seu estilo</h1>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseOne" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer5.png" class="card-img-top Paletó1" alt="Paletó 1">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTwo" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer9.png" class="card-img-top" alt="Paletó 2">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseThree" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer14.png" class="card-img-top" alt="Paletó 3">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFour" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer4.png" class="card-img-top Paletó4" alt="Paletó 4">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer8.png" class="card-img-top" alt="Paletó 5">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer16.png" class="card-img-top" alt="Paletó 6">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSeven" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer2.png" class="card-img-top" alt="Paletó ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseEight" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer3.png" class="card-img-top grav4" alt="Paletó ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseNine" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer6.png" class="card-img-top borb1" alt="Paletó 9">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer12.png" class="card-img-top borb2" alt="Paletó 10">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseEleven" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer10.png" class="card-img-top borb3" alt="Paletó 11">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTwelve" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer11.png" class="card-img-top borb4" alt="Paletó 12">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseThirteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer15.png" class="card-img-top" alt="Paletó 13">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFourteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer13.png" class="card-img-top" alt="Paletó 14">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó </h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFifteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer1.png" class="card-img-top" alt="Paletó 15">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSixteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Blazer/blazer7.png" class="card-img-top" alt="Paletó 16">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Paletó</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$500,00</h6>
                                </div>
