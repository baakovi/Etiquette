        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-center" style="margin: 10% 0 10% 0;">
                    ...
                    <h1 class="amostra-text">Coletes de linho e veludo, o favorito da alfaiataria e ideal para você!</h1>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseOne" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete4.png" class="card-img-top Terno1" alt="Colete Social 1">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTwo" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete3.png" class="card-img-top" alt="Colete Social 2">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseThree" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete1.png" class="card-img-top" alt="Colete Social 3">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFour" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete14.png" class="card-img-top Colete4" alt="Colete Social 4">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete16.png" class="card-img-top" alt="Colete Social 5">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete2.png" class="card-img-top" alt="Colete Social 6">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSeven" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete11.png" class="card-img-top" alt="Colete Social ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseEight" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete15.png" class="card-img-top grav4" alt="Colete Social ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseNine" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete6.png" class="card-img-top borb1" alt="Colete Social 9">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete5.png" class="card-img-top borb2" alt="Colete Social 10">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseEleven" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete12.png" class="card-img-top borb3" alt="Colete Social 11">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$450,00</h6>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTwelve" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete8.png" class="card-img-top borb4" alt="Colete Social 12">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseThirteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete7.png" class="card-img-top" alt="Colete Social 13">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFourteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete9.png" class="card-img-top" alt="Colete Social 14">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFifteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete10.png" class="card-img-top" alt="Colete Social 15">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSixteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Colete/colete13.png" class="card-img-top" alt="Colete Social 16">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Colete Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$450,00</h6>
                                </div>
