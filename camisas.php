        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-center" style="margin: 10% 0 10% 0;">
                    ...
                    <h1 class="amostra-text">Camisas feitas com melhor tecido, ideal para ocasiões importantes</h1>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseOne" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa1.png" class="card-img-top Camisa1" alt="Camisa Social 1">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$290,00</h6>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTwo" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa2.png" class="card-img-top" alt="Camisa Social 2">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseThree" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa3.png" class="card-img-top" alt="Camisa Social 3">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$290,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFour" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa4.png" class="card-img-top Camisa Social4" alt="Camisa Social 4">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$330,00</h6>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa5.png" class="card-img-top" alt="Camisa Social 5">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$280,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa6.png" class="card-img-top" alt="Camisa Social 6">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$270,00</h6>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSeven" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa7.png" class="card-img-top" alt="Camisa Social ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$290,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseEight" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa8.png" class="card-img-top grav4" alt="Camisa Social ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseNine" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa9.png" class="card-img-top borb1" alt="Camisa Social 9">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$290,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa10.png" class="card-img-top borb2" alt="Camisa Social 10">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$280,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseEleven" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa11.png" class="card-img-top borb3" alt="Camisa Social 11">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$290,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTwelve" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa12.png" class="card-img-top borb4" alt="Camisa Social 12">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseThirteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa13.png" class="card-img-top" alt="Camisa Social 13">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$280,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFourteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa14.png" class="card-img-top" alt="Camisa Social 14">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFifteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa15.png" class="card-img-top" alt="Camisa Social 15">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$290,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSixteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Camisa/camisa16.png" class="card-img-top" alt="Camisa Social 16">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Camisa Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
