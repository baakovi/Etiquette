        ...
        <div class="container" style="padding: 60px 0 60px 0;">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 p-0">
                    ...
                    <h1 class="text-profile pt-5 my-4">
                        
                        Endereços

                        <a href="addresses.php"><button type="button" class="btn btn-dark" style="float: right;">Adicionar endereço</button></a>
                    ...
                    <!-- <div class="row profile">
                        <div class="col-lg-6">
                            ...
                            <p class="text-muted">Nome da pessoa</p>
                            <br>
                    ...
                    <h4 class="text-muted text-center">Você não tem nenhum endereço cadastrado!</h4>
