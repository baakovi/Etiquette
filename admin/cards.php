            ...
            <div class="row">
                ...
                <div class="col-lg-9 p-0">
                    ...
                    <h1 class="text-profile pt-5 my-4">
                        ...
                        <a href="addresses.php"><button type="button" class="btn btn-dark" style="float: right;">Adicionar cartão</button></a>

                    </h1>

                    <h4 class="fw-bold text-center">Você não tem nenhum método de pagamento registrado.</h4>
