        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-center" style="margin: 10% 0 10% 0;">
                    ...
                    <h1 class="amostra-text">Calças de lã fria, mistura o conforto com a sofisticação</h1>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseOne" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca1.png" class="card-img-top Terno1" alt="Calça Social 1">
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTwo" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca5.png" class="card-img-top" alt="Calça Social 2">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseThree" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca14.png" class="card-img-top" alt="Calça Social 3">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFour" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca7.png" class="card-img-top Calça Social4" alt="Calça Social 4">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca3.png" class="card-img-top" alt="Calça Social 5">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social </h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca4.png" class="card-img-top" alt="Calça Social 6">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSeven" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca6.png" class="card-img-top" alt="Calça Social ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseEight" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca8.png" class="card-img-top grav4" alt="Calça Social ">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social </h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseNine" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca16.png" class="card-img-top borb1" alt="Calça Social 9">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca11.png" class="card-img-top borb2" alt="Calça Social 10">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseEleven" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca9.png" class="card-img-top borb3" alt="Calça Social 11">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseTwelve" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca13.png" class="card-img-top borb4" alt="Calça Social 12">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseThirteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca10.png" class="card-img-top" alt="Calça Social 13">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFourteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca12.png" class="card-img-top" alt="Calça Social 14">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseFifteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca2.png" class="card-img-top" alt="Calça Social 15">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social</h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-2">
                    <div class="accordion-wrap">
                        <a class="accordion" data-toggle="collapse" href="#collapseSixteen" role="button" aria-expanded="false">
                            <div class="card">
                                <img src="Produtos/Calça/calca15.png" class="card-img-top" alt="Calça Social 16">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Calça Social </h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary fw-bold">R$300,00</h6>
                                </div>
